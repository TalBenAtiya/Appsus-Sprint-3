...
export function NoteList({ notes, onChangeBackgroundColor, onchangeTxt, onchangeTodoTxt, onTodoIsDone, onRemoveNote, onaddLabel,onchangeLabelTxt,onRemoveLabel,onMakePinned }) {
